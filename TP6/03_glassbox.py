...
# Tri par importance absolue pour la visualisation
feature_importance['Abs_Coefficient'] = feature_importance['Coefficient'].abs()
# On trie pour avoir les plus importants à la fin pour le barh
...
colors = ['red' if c < 0 else 'blue' for c in feature_importance_sorted['Coefficient']]

plt.barh(feature_importance_sorted['Feature'][-15:], feature_importance_sorted['Coefficient'][-15:], color=colors[-15:])
...
output_filename = os.path.join(script_dir, "outputs", "glassbox_coefficients.png")
