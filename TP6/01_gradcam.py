...
# Si le chemin n'est pas absolu ou relatif au CWD, on essaie de le trouver dans le dossier du script
...
# On cible la dernière couche du dernier stage du ResNet
...
# Interpolation pour retrouver la taille de l'image d'entrée
...
# On sauvegarde dans le dossier outputs du TP6
script_dir = os.path.dirname(os.path.abspath(__file__))
base_name = os.path.basename(image_path).split('.')[0]
output_filename = os.path.join(script_dir, "outputs", f"gradcam_{base_name}.png")
