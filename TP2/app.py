...
def get_text2img_pipe(model_id: str, scheduler_name: str):
    ...
    # pipe.enable_xformers_memory_efficient_attention() # Disabled due to previous compatibility issues
    return pipe
...
prompt = st.text_area("Prompt", value="a professional e-commerce product photo of a backpack, studio lighting, white background")
...
if run:
    ...
    if mode == "Text2Img":
        ...
        # The input image for img2img needs to be resized to 512x512
